...
DiscordBtn.Size = UDim2.new(0.82, 0, 0, 44)
DiscordBtn.Position = UDim2.new(0.09, 0, 0, 94)
...
EnableBtn.Size = UDim2.new(0.82, 0, 0, 44)
EnableBtn.Position = UDim2.new(0.09, 0, 0, 150)
EnableBtn.BackgroundColor3 = Color3.fromRGB(0, 200, 100)
EnableBtn.Text = "Enable Script"
...
DiscordBtn.MouseButton1Click:Connect(function()
	pcall(function()
		setclipboard("discord.gg/sPCKm8juf")
	end)
...
TAbout:CreateLabel({ Text = "Rix Hub v1.1.0", Style = 1 })
...
TAbout:CreateLabel({ Text = "- Anti AC (manual toggle)", Style = 2 })
...
LP.CharacterAdded:Connect(function()
 ...
 -- REMOVED: auto anti-cheat startup
 -- _acActive = false
 -- task.delay(1, SetupAntiCheatBypass)
...
-- REMOVED: SetupAntiCheatBypass()
Notify("Rix Hub", "v1.1.0")
print("Rix Hub v1.1.0")
